...
| 2026-08-01 | Player Vitals + Stance Switching (Phase 3, slice 1) | Done — PlayerVitals (real health/stamina/posture firing EventBus), StanceController (Q/Tab cycling), DodgeAbility now spends real stamina via IStaminaSource. QA passed clean, no fix loop. **Play Mode not yet manually verified.** | [2026-08-01-player-vitals-stance-switching.md](Tasks/2026-08-01-player-vitals-stance-switching.md) |
