...
// Single-responsibility bar: displays EventBus.PlayerStaminaChanged only. See
...
public class StaminaBar : MonoBehaviour
{
    ...
    private void Awake()
    {
        // Sane default: no real emitter fires PlayerStaminaChanged yet (Phase 3/Combat territory).
        if (fillImage != null)
    ...
    {
        EventBus.PlayerStaminaChanged += HandleChanged;
    }
